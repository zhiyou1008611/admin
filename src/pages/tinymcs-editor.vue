<template>
  <div id="publish" v-loading="loading" element-loading-text="加载中...">
    ...
    <div class="write">
      ...
      <div class="link">
        <el-switch v-model="disabled" active-text="使用链接"></el-switch>
        <el-input
          type="text"
          size="medium"
          v-if="disabled"
      ...
      <div class="cover edit-cell">
        ...
        <div class="edit-input">
          ...
          <div class="cover_images">
            <template>
              <div v-for="(item,index) in cover_mode" :key="index" style="display:inline-block">
      ...
      files.map((item, index) => {
        ...
        if (item) {
          this.editor.insertEmbed(
            this.editor.getSelection().index + index,
            "image",
            item
          );
        }
